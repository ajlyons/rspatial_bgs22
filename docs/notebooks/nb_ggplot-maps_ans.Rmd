...
```{r}
## City boundary
sf_citybnd_ll <- st_read(dsn = file.path(data_dir, "sf_citybnd.geojson"))
sf_citybnd_ll

## City neighborhoods
sf_nb_ll <- st_read(dsn = file.path(data_dir, "sf_nb.geojson"))
sf_nb_ll
```
...
```{r}
## City neighborhoods
sf_gencln_ll <- st_read(dsn = file.path(data_dir, "sf_311_strt-sdwk-gncln_2015-21.gpkg"))
